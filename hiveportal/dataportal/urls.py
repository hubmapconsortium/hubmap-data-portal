...
urlpatterns = [
    ...
    path('query/institution/<int:id>', views.indexByGroup, name='group'),
    path('query/datatype/<int:id>', views.indexByGroup, name='group'),
    path('query/tissue/<int:id>', views.indexByGroup, name='group'),
    path('query/subclass/<int:id>', views.indexByGroup, name='group'),
