...
urlpatterns = [
    ...
    path('study/genes/<int:id>', views.filterby_protein_gene, name='study_gene_index'),
    path('study/proteins/<int:id>', views.filterby_protein_gene, name='study_protein_index'),
